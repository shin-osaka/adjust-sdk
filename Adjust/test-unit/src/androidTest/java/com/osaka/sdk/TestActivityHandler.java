...
public class TestActivityHandler {
    ...
    protected com.osaka.sdk.test.UnitTestActivity activity;
    protected Context context;
    protected AssertUtil assertUtil;

    @Rule
    public ActivityTestRule<com.osaka.sdk.test.UnitTestActivity> mActivityRule = new ActivityTestRule(com.osaka.sdk.test.UnitTestActivity.class);
    ...
    public void testChecks() {
        ...
        assertUtil.info("Skipping initialization in background process (com.osaka.sdk.test.test)");
        ...
        configCorrectProcess.setProcessName("com.osaka.sdk.test.test");
