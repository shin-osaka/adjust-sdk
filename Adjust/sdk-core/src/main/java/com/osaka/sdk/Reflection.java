...
public class Reflection {
    ...
    static Map<String, String> getImeiParameters(Context context, ILogger logger) {
        ...
        try {
            nonPlayParameters = invokeStaticMethod("com.osaka.sdk.imei.Util", "getImeiParameters", new Class[]{Context.class, ILogger.class}, context, logger);
    ...
    static Map<String, String> getOaidParameters(Context context, ILogger logger) {
        ...
        try {
            oaidParameters = invokeStaticMethod("com.osaka.sdk.oaid.Util", "getOaidParameters", new Class[]{Context.class, ILogger.class}, context, logger);
            Class<Map<String, String>> stringStringMapClass = (Class<Map<String, String>>) (Class) Map.class;
    ...
    public static ReferrerDetails getSamsungReferrer(Context context, ILogger logger) {
        ...
        try {
            referrerDetails = (ReferrerDetails) invokeStaticMethod("com.osaka.sdk.samsung.Util",
    ...
    public static ReferrerDetails getXiaomiReferrer(Context context, ILogger logger) {
        ReferrerDetails referrerDetails = null;
        try {
            referrerDetails = (ReferrerDetails) invokeStaticMethod("com.osaka.sdk.xiaomi.Util",
    ...
    public static ReferrerDetails getVivoReferrer(Context context, ILogger logger) {
        ReferrerDetails referrerDetails = null;
        try {
            referrerDetails = (ReferrerDetails) invokeStaticMethod("com.osaka.sdk.vivo.Util",
    ...
    public static String getSamsungCloudDevGoogleAdId(Context context, ILogger logger) {
        ...
        try {
            googleAdId = (String) invokeStaticMethod("com.osaka.sdk.samsung.clouddev.Util",
                    "getGoogleAdId",
                    new Class[]{Context.class, ILogger.class},
                    context, logger);
        } catch (Exception e) {
    ...
    public static boolean isAppRunningInSamsungCloudEnvironment(Context context, ILogger logger) {
        ...
        try {
            isCloudEnvironment = (boolean) invokeStaticMethod("com.osaka.sdk.samsung.clouddev.Util",
